...
import heero.wakcraft.network.packet.IPacket;
...
public class PacketPipeline extends
	...
	protected void decode(ChannelHandlerContext ctx, FMLProxyPacket msg, List<Object> out) throws Exception {
		...
		Class<? extends IPacket> packetClass = this.packets.get(discriminator);
		if (packetClass == null) {
	...
	public void initialise() {
		this.channels = NetworkRegistry.INSTANCE.newChannel("wakcraftChannel", this);
	}
