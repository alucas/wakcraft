...
public class Bouftou extends EntityAnimal {
	...
	static {
		dropRate.put(Item.getIdFromItem(WakcraftItems.LaineDeBouftou), 50);
		dropRate.put(Item.getIdFromItem(WakcraftItems.CuirDeBouftou), 50);
		dropRate.put(Item.getIdFromItem(WakcraftItems.CorneDeBouftou), 50);
		dropRate.put(Item.getIdFromItem(WakcraftItems.ClefLaineuse), 5);
	}

	public Bouftou(World par1World) {
		super(par1World);
		...
		this.inventory.setInventorySlotContents(0, new ItemStack(WakcraftItems.CorneDeBouftou, 1, 0));
		this.inventory.setInventorySlotContents(1, new ItemStack(WakcraftItems.LaineDeBouftou, 1, 0));
		this.inventory.setInventorySlotContents(2, new ItemStack(WakcraftItems.CuirDeBouftou, 1, 0));
		this.inventory.setInventorySlotContents(3, new ItemStack(WakcraftItems.ClefLaineuse, 1, 0));
	}
	...
	public Bouftou createChild(EntityAgeable par1EntityAgeable) {
		return new Bouftou(this.worldObj);
	}
