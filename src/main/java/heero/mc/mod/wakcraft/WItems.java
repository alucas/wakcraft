...
public class WItems extends Items {
	...
	public static void registerItems() {
		...
		GameRegistry.registerItem(spellImpact = (new ElementalSpell("Impact", 2, 0, 0).setEffect(new EffectDamage(2, 48 / 200.0F, EffectArea.CROSS)).setEffectCritical(new EffectDamage(3, 72 / 200.0F, EffectArea.CROSS))), "SpellImpact");
		GameRegistry.registerItem(spellCharge = (new ElementalSpell("Charge", 4, 1, 0).setEffect(new EffectDamage(3, 100 / 200.0F)).setEffect(new EffectState(State.STUNNED, 1, 0, 0.10F, 0)).setEffectCritical(new EffectDamage(5, 146 / 200.0F)).setEffectCritical(new EffectState(State.STUNNED, 1, 0, 0.15F, 0))), "SpellCharge");
