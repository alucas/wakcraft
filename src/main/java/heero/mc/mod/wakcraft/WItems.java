...
public class WItems extends Items {
	...
	public static void registerItems() {
		...
		GameRegistry.registerItem(spellDevastate = (new ElementalSpell("Devastate", 5, 1, 0).setEffect(new EffectDamage(7, 136 / 200.0F, EffectElement.EARTH, EffectArea.AROUND)).setEffect(new EffectCharacteristic(Characteristic.MOVEMENT, -1, 0, 0.3F, 0, EffectArea.AROUND)).setEffectCritical(new EffectDamage(11, 173 / 200.0F, EffectElement.EARTH, EffectArea.AROUND)).setEffectCritical(new EffectCharacteristic(Characteristic.MOVEMENT, -1, 0, 0.45F, 0, EffectArea.AROUND))), "SpellDevastate");
