...
public class BlockVein1 extends BlockVein {
    ...
    protected static final PropertyEnum<EnumOre> PROP_ORE = PropertyEnum.create("ore", EnumOre.class, new EnumOre.EnumOrePredicate(0));
