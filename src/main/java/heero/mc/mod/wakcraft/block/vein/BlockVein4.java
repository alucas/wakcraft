...
public class BlockVein4 extends BlockVein {
    ...
    protected static final PropertyEnum<EnumOre> PROP_ORE = PropertyEnum.create("ore", EnumOre.class, new EnumOre.EnumOrePredicate(3));
