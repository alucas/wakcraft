...
public class WBlocks {
	...
	public static void registerBlocks() {
		...
		GameRegistry.registerBlock(sufokiaWave1NorthSlab = (new BlockYRotationSlab(Material.ground, WBlocks.sufokiaWave, 2, ForgeDirection.NORTH).setBlockTextureName(ForgeDirection.EAST, "ground15").setBlockTextureName(ForgeDirection.WEST, "ground15").setBlockTextureName(ForgeDirection.NORTH, "ground15").setBlockTextureName(ForgeDirection.SOUTH, "ground15").setBlockTextureName("sufokiaWave1").setBlockName("sufokiaWave1NorthSlab")), ItemBlockSlab.class, "sufokiaWave1NorthSlab");
		GameRegistry.registerBlock(sufokiaWave1SouthSlab = (new BlockYRotationSlab(Material.ground, WBlocks.sufokiaWave, 0, ForgeDirection.SOUTH).setBlockTextureName(ForgeDirection.EAST, "ground15").setBlockTextureName(ForgeDirection.WEST, "ground15").setBlockTextureName(ForgeDirection.NORTH, "ground15").setBlockTextureName(ForgeDirection.SOUTH, "ground15").setBlockTextureName("sufokiaWave1").setBlockName("sufokiaWave1SouthSlab")), ItemBlockSlab.class, "sufokiaWave1SouthSlab");
		GameRegistry.registerBlock(sufokiaWave1EastSlab = (new BlockYRotationSlab(Material.ground, WBlocks.sufokiaWave, 3, ForgeDirection.EAST).setBlockTextureName(ForgeDirection.EAST, "ground15").setBlockTextureName(ForgeDirection.WEST, "ground15").setBlockTextureName(ForgeDirection.NORTH, "ground15").setBlockTextureName(ForgeDirection.SOUTH, "ground15").setBlockTextureName("sufokiaWave1").setBlockName("sufokiaWave1EastSlab")), ItemBlockSlab.class, "sufokiaWave1EastSlab");
		GameRegistry.registerBlock(sufokiaWave1WestSlab = (new BlockYRotationSlab(Material.ground, WBlocks.sufokiaWave, 1, ForgeDirection.WEST).setBlockTextureName(ForgeDirection.EAST, "ground15").setBlockTextureName(ForgeDirection.WEST, "ground15").setBlockTextureName(ForgeDirection.NORTH, "ground15").setBlockTextureName(ForgeDirection.SOUTH, "ground15").setBlockTextureName("sufokiaWave1").setBlockName("sufokiaWave1WestSlab")), ItemBlockSlab.class, "sufokiaWave1WestSlab");
		...
		GameRegistry.registerBlock(sufokiaWave3NorthSlab = (new BlockCenterCornerSlab(Material.ground, WBlocks.sufokiaWave, 10, ForgeDirection.NORTH).setBlockCornerTextureName("sufokiaWave3Corner").setBlockTextureName("sufokiaWave3").setBlockName("sufokiaWave3NorthSlab")), ItemBlockSlab.class, "sufokiaWave3NorthSlab");
		GameRegistry.registerBlock(sufokiaWave3SouthSlab = (new BlockCenterCornerSlab(Material.ground, WBlocks.sufokiaWave, 8, ForgeDirection.SOUTH).setBlockCornerTextureName("sufokiaWave3Corner").setBlockTextureName("sufokiaWave3").setBlockName("sufokiaWave3SouthSlab")), ItemBlockSlab.class, "sufokiaWave3SouthSlab");
		GameRegistry.registerBlock(sufokiaWave3EastSlab = (new BlockCenterCornerSlab(Material.ground, WBlocks.sufokiaWave, 11, ForgeDirection.EAST).setBlockCornerTextureName("sufokiaWave3Corner").setBlockTextureName("sufokiaWave3").setBlockName("sufokiaWave3EastSlab")), ItemBlockSlab.class, "sufokiaWave3EastSlab");
		GameRegistry.registerBlock(sufokiaWave3WestSlab = (new BlockCenterCornerSlab(Material.ground, WBlocks.sufokiaWave, 9, ForgeDirection.WEST).setBlockCornerTextureName("sufokiaWave3Corner").setBlockTextureName("sufokiaWave3").setBlockName("sufokiaWave3WestSlab")), ItemBlockSlab.class, "sufokiaWave3WestSlab");
		GameRegistry.registerBlock(wood1NorthSlab = (new BlockYRotationSlab(Material.wood, WBlocks.wood, 2, ForgeDirection.NORTH).setBlockTextureName("wood").setBlockName("Wood1NorthSlab")), ItemBlockSlab.class, "wood1NorthSlab");
		GameRegistry.registerBlock(wood1SouthSlab = (new BlockYRotationSlab(Material.wood, WBlocks.wood, 0, ForgeDirection.SOUTH).setBlockTextureName("wood").setBlockName("Wood1SouthSlab")), ItemBlockSlab.class, "wood1SouthSlab");
		GameRegistry.registerBlock(wood1EastSlab = (new BlockYRotationSlab(Material.wood, WBlocks.wood, 3, ForgeDirection.EAST).setBlockTextureName("wood").setBlockName("Wood1EastSlab")), ItemBlockSlab.class, "wood1EastSlab");
		GameRegistry.registerBlock(wood1WestSlab = (new BlockYRotationSlab(Material.wood, WBlocks.wood, 1, ForgeDirection.WEST).setBlockTextureName("wood").setBlockName("Wood1WestSlab")), ItemBlockSlab.class, "wood1WestSlab");
