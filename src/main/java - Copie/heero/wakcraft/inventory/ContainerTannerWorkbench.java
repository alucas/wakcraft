...
public class ContainerTannerWorkbench extends Container {
	...
	protected TileEntityTannerWorkbench tile_entity;
	private World worldObj;

	public ContainerTannerWorkbench(TileEntityTannerWorkbench tile_entity,
			InventoryPlayer player_inventory, World world) {
		this.worldObj = world;
